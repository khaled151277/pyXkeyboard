...
X11_KEYSYM_MAP = {
    ...
    'Y': XK.XK_y, 'Z': XK.XK_z,
    # Special application keys map to None (handled internally)
    'About': None, 'Set': None,
    'Minimize': None, 'Close': None,
    'Donate': None,
    # --- *** تعديل: إضافة أسماء أزرار اللغة الجديدة *** ---
    'Lang1': None, 'Lang2': None, 'Lang3': None,
    # --- *** نهاية التعديل *** ---
}
...
# --- *** تعديل: استخدام أسماء Lang1, Lang2, Lang3 في التخطيط *** ---
# --- Keyboard Layout Structure (updated) ---
KEYBOARD_LAYOUT = [
    ...
    [('`', 1, 1), ('1', 1, 1), ('2', 1, 1), ('3', 1, 1), ('4', 1, 1), ('5', 1, 1), ('6', 1, 1), ('7', 1, 1), ('8', 1, 1), ('9', 1, 1), ('0', 1, 1), ('-', 1, 1), ('=', 1, 1), ('Backspace', 1, 2), None, ('PrtSc', 1, 1), ('Scroll Lock', 1, 1), ('Pause', 1, 1), ('Lang2', 1, 1)], # Changed to Lang1
    ...
    [('L Ctrl', 1, 2), ('L Win', 1, 1), ('L Alt', 1, 1), ('Lang1', 1, 1), ('Space', 1, 5), ('Lang3', 1, 1), ('R Alt', 1, 1), ('R Win', 1, 1), ('App', 1, 1), ('R Ctrl', 1, 2), ('Left', 1, 1), ('Down', 1, 1), ('Right', 1, 1), ('Donate', 1, 1)] # Changed to Lang2, Lang3
]
# --- *** نهاية التعديل *** ---
# file:key_definition.py
